...
class MaskRCNN:
    ...
    def load_weights(self, filepath='/home/shadow_/Desktop/DUMP/OracleVision/weights.h5', by_name=False, exclude=None):
        import h5py
        try:
        ...
        print()
        f = h5py.File(os.path.join(os.getcwd(), self.model_dir), mode='r')
    ...
    def detect(self, images, verbose=0):
        ...
        print(f'Took {time.perf_counter()-t1} sec')
        # Process detections
        results = []
